	...
	<div id="container">
    	<div class="main_rolling_pc box_inner">
            ...
            <div id="page_myPage"> 
                ...
                <div id="p_myList">
                    <a class="p_myL p_Using" href="./otherperson.jsp?userid=<%=otherId%>">
                        <span class="p_mLimg">
                    ...
                    <a class="p_myL" href="./othertagged.jsp?userid=<%=otherId%>">
                        <span class="p_mLimg">
				...
				%>
                    ...
                    <%
						...
						for(int i=0; i<otherConList.size(); i++){
					%>
						<ul class="p_myCBox">
							<li>
								<a class="" href="../contentPage.jsp?b_idx=<%=otherConList.get(i).getMc_idx()%>">
								<img class="p_myCBoxImg" alt="" src="../uploads/<%=otherConList.get(i).getMc_imageurl()%>">									
								</a>
							</li>
						</ul>
					<%
